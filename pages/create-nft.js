...
const CreateNFT = () => {
  ...
  const fileStyles = useMemo(() => (
    `dark:bg-nft-black-1 bg-white border dark:border-white border-nft-gray-2 flex flex-col items-center p-5 rounded-sm border-dashed ${isDragActive && 'border-file-active'}
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
        ...
        <div className="mt-16">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold rext-xl">Upload File</p>
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyles}>
              ...
              <div className="flexCenter flex-col text-center">
                ...
                <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm mt-2">or Browser media on your device</p>
              </div>
